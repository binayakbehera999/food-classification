...
epoch=50
model_dir="model" #only priviouse model directory for feature extraction
...
if __name__ == '__main__':
  ...
  # parser.add_argument('--image_dir',type=str,default='training_dataset')
  parser.add_argument('--output_graph', type=str, default='tf_files/retrained_graph.pb')
  parser.add_argument('--output_labels', type=str, default='tf_files/retrained_labels.txt')
  parser.add_argument('--summaries_dir', type=str, default='tf_files/training_summaries/basic')
  ...
  parser.add_argument('--bottleneck_dir', type=str, default='tf_files/bottlenecks')
